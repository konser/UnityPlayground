...
[ExecuteInEditMode]
public class ScatterLight : ScatterObject
{
    ...
    static Material ShadowFilterMaterial
    {
        get
        {
            ...
            {
                s_shadowFilterMaterial = new Material(Shader.Find("Hidden/Scatter/ShadowFilterESM"));
            }
    ...
    static Material ScreenShadowMaterial
    {
        get
        {
            ...
            {
                s_screenShadowMaterial = new Material(Shader.Find("Hidden/Scatter/ShadowProperties"));
            }
    ...
    static Material ShadowBlurMaterial
    {
        get
        {
            ...
            {
                s_shadowBlurMaterial = new Material(Shader.Find("Hidden/Scatter/ShadowBlur"));
            }

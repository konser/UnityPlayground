    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                float3 pos1 = movement(float4(i.vertex.x+2 , i.vertex.y, i.vertex.z, i.vertex.w), i.uv).xyz;
                float3 pos2 = movement(float4(i.vertex.x, i.vertex.y, i.vertex.z +1, i.vertex.w), i.uv).xyz;
